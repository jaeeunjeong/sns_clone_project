...
import com.demo.project.sns.controller.response.CommentResponse;
...
public class PostController {
    ...
    public Response<Page<CommentResponse>> commentList(@PathVariable Long postId, Pageable pageable){
